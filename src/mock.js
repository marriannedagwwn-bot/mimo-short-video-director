...
const allowedComponentGuidance = [
  "【原片有】原片主线是把某物送到某人手中。保留该目标压力，改写物品、接收者和阻碍。",
  "【原片有】原片包含跨空间移动的旅途段落。保留空间推进带来的关系升温，改写路线、交通方式与停靠事件。",
  "【原片有】原片用一件随身物件承载情绪。按当前剧情需要选择日常物件承载情绪；来源物件不是禁词，也不得因来源存在而机械注入。",
  "【原片有】原片中主角在途中获得他人援助。保留陌生人或同伴援助的情绪回报，改写帮助者身份与帮助方式。",
  "【原片有】原片存在被主角照顾的对象。保留显性需求与隐性需求的双层设计，重建人物关系与具体处境。",
  "【原片有】原片用环境变化推动情绪转折。继续让环境形成外部阻力和氛围，但采用新的场景调度。",
  "【原片有】原片以一个生活化小动作收尾。保留小动作收束情绪的方式，重新设计结尾动作和道具。"
];
