...
- **slice_of_life（生活片段型）**：主角**参与**一件正在发生的事，可以没有目标、没有非做不可的任务。它靠角色魅力、生活质感和人物关系留住观众，不靠悬念。参考片大量使用这一路径：有的片子主角推门进院、一颗果子掉下来、她就自然加入了长辈的劳作；有的片子主角从第三场起一直睡着，全片是别人在她不知情时为她做的事。**这类故事同样成立，而且往往更耐看、更不刻意。**
